...
def build_sidebar():
    ...
    sidebar.append(make_sidebar_item("mail-unread-symbolic", "Emails"))
    sidebar.append(make_sidebar_item("folder-visiting-symbolic", "Folders"))
    sidebar.append(make_sidebar_item("preferences-system-symbolic", "Settings"))
